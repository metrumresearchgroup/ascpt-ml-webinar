...
Sanity check the shapley predictions by making predictions for two different values of tumor sizes for one set of covariate values. This is analagous to plotting the predictions for a reference individual and permuting the one covariate.
