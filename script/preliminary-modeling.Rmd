...
# TODO:Precision-recall AUC
# Remove this for exercise
final_fit_weighted %>%
    collect_predictions() %>% 
    pr_auc(Class, `.pred_recurrence-events`, event_level = "first")

# TODO: Compare this ROC AUC with the previous model.
# Remove this for exercise
final_fit_weighted %>%
    collect_predictions() %>% 
    roc_auc(Class, `.pred_recurrence-events`, event_level = "first")
...
## BONUS CONTENT: Model interpretation with Shapley Values
